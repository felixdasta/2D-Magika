...
public class Brick extends StaticEntity {
    ...
    public Brick(Handler handler, float x, float y) {
        ...
        try {
            audioFile = new File("res/music/Brick.wav");
    ...
    public void die() {
        ...
        if(RNGR==1){
            handler.getWorld().getItemManager().addItem(Item.coin.createNew((int)x + bounds.x + (randint.nextInt(32) -32),(int)y + bounds.y+(randint.nextInt(32) -32),1));
        }
